...
// count by returning null instead of letting the underlying BigInt
// division's native "RangeError: Division by zero" propagate uncaught
// (mirrors the Go/Rust/Python fixture apps' divide-by-zero guards).
/**
 * @param {number} total
 * @param {number} parts
 * @returns {number | null}
