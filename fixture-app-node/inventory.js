...
// checkInventory forwards the downstream inventory service's actual
// status code and body to the caller, rather than always reporting a
// successful 200 lookup regardless of what the downstream service
// returned.
/**
 * @param {string} sku
